...
SimpleCast is an AioRTC based software that takes any video and audio frames and sends them over the network via the WebRTC standard to 'cast' to another display. Completely complient with WebRTC and HTTP standards, so implementing a custom client is easy, along with automation. It runs on any Debian flavored distro.
...
Not a replacement for an HDMI cable if one can be ran or is wanted. Depending on hardware ran on it might be able to display 4K, it probably cannot STREAM 4k, defaults to 720p for balance between framerate and resolution. 
...
<img src="assets/server_link.png" alt="The open screen of the simplecast server, had the download link and the background is a tropical beach" width="800"/> <br>
...
<img src="assets/server_debug.png" alt="The open screen of the simplecast server, with debug info active, background is of a bird" width="800"/> <br>
...
<img src="assets/server_pin.png" alt="The connecting screen of the simplecast server, showing a pin of 18067, background is of lavander" width="800"/> <br>

<img src="assets/client_open.png" alt="The open screen of the simplecast client, showing one discovered server, and two favorited servers." width="800"/> <br>

<img src="assets/client_pin.png" alt="The connecting screen of the simplecast client, showing a textbox to enter the pin" width="800"/> <br>

<img src="assets/client_connected.png" alt="The connected screen of the simplecast client, saying 'You are connected'" width="800"/> <br>

<img src="assets/server_debug_rickroll.png" alt="The connected screen of the simplecast server, shoiwng debug info, you just got rick rolled" width="800"/> <br>
